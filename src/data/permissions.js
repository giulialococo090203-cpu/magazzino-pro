export const PERMISSIONS = [
  ...
  {
    key: 'canManageReorders',
    label: 'Riordino automatico',
    description: 'Può generare, esportare e gestire proposte d’ordine dai materiali sotto soglia',
    group: 'Configurazione',
  },
  {
    key: 'canManagePhysicalInventory',
    label: 'Inventario fisico',
    description: 'Può creare sessioni di inventario fisico, contare materiali e generare rettifiche',
    group: 'Magazzino',
  },
  {
...
export const DEFAULT_ROLE_PERMISSIONS = {
  operaio: {
    ...
    canManageReorders: false,
    canManagePhysicalInventory: false,
  ...
  segretaria: {
    ...
    canManagePriceSettings: false,
    canManageReorders: true,
    canManagePhysicalInventory: true,
